...
#define NAME  LethalStr("Host Project")
#define NAME_LOADER LethalStr("Host Project")
...
#include <string>
#include <C:\Users\Yusuf Serdar\Desktop\Loader-master\C++ Loader\C++ Loader\curl lib\include\curl\curl.h>
